...
function init() {
  ...
  async function addTodo() {
    ...
    if (newTodo.value.length > 0) {     //tarkistaa onko kenttä tyhjä
    ...
    alert("Tehtävä kenttä ei voi olla tyhjä") //Palauttaa virheilmoituksen jos kenttä on tyhjä
   }
  }
  ...
  async function updateTodo(id) {
    ...
    if (newTodo.value.length > 0) {   //tarkistaa onko kenttä tyhjä
      if (confirm("Haluatko varmasti päivittää tehtävän?") == true) {
